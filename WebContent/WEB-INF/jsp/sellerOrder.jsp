...
<div class="control-inline" style="box-shadow: 10px 10px 5px #888888;border:2px solid;border-radius:25px;">
	...
	Payment Card: Ending with ${order.cardNum}<br>
	...
	&nbsp;&nbsp;&nbsp;
 	<a href="confirm/${order.id}.htm" class="btn btn-success">
	<span class="glyphicon glyphicon-ok"></span> Confirm Order</a>
	<a href="decline/${order.id}.htm" class="btn btn-danger">
	<span class="glyphicon glyphicon-remove"></span> Decline Order</a>
	</c:if>
	<c:if test="${order.status == 'Confirmed'}">
	&nbsp;&nbsp;&nbsp;
	<a href="complete/${order.id}.htm" class="btn btn-success">
	<span class="glyphicon glyphicon-ok"></span> Confirm Delivered</a>
	</c:if>
	</div>
	</c:forEach>
</body>
